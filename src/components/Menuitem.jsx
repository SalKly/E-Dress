    ...
    <div className='MenuCardContainer'>
      ...
      <Link to={`/ProductInfo/${props.data._id}`} className=' MenuCardLink' onClick={() => {
        ...
        <div className={props.state === "1" ? 'MenuCardImgs MenuCartmResp' : 'MenuCardImgs'}>
          <img className={props.state === "0" ? 'imgBack Responsive' : 'imgBack'} src={props.data.imgBack} />
          <img className={props.state === "0" ? 'imgFront Responsive' : 'imgFront'} src={props.data.imgFront} />
