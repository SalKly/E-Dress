  ...
  return (
    <Router >
      ...
      <Routes>
        ...
        <Route path='/' element={<div> <Nav topstate={topstate} TotalPrice={TotalPrice} SetTotalPrice={SetTotalPrice} CartInfo={CartInfo} SetCartInfo={SetCartInfo} infoGet={mainNav}></Nav>
